...
def resaltar_sintaxis(event=None):
    ...
    PALABRAS_RESERVADAS = [
        "False", "main", "None", "True", "and", "as", "assert", "async", "await", "break", 
        "class", "continue", "def", "del", "elif", "else", "except", "finally", 
        "for", "from", "global", "if", "import", "in", "is", "lambda", "nonlocal", "double",
        "not", "or", "pass", "raise", "return", "try", "while", "with", "yield", "int", "cout", "cin", "do", "switch" , "case", 
    ] 
...
icono_abrir = ImageTk.PhotoImage(Image.open("IDEcompilador/Iconos/abrir-documento.png"))
icono_guardar = ImageTk.PhotoImage(Image.open("IDEcompilador/Iconos/guardar.png"))
icono_compilar = ImageTk.PhotoImage(Image.open("IDEcompilador/Iconos/compile.png"))
icono_salir = ImageTk.PhotoImage(Image.open("IDEcompilador/Iconos/exit.png"))
icono_compilar_y_depurar = ImageTk.PhotoImage(Image.open("IDEcompilador/Iconos/debug.png"))
